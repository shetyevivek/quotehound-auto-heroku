...
class SR22 extends Component {

    nextStep = (values) => {

        values.preventDefault();
        
        let sr = values.currentTarget.dataset.value;
       ...
       this.props.setSR(sr)
        ...
        this.props.history.push('/active-license' + '?zip_code=' + zipCode + '&car_year=' + carYear + '&car_model=' + carModel + '&car_make=' + carMake + '&primary_usage=' + use + '&annual_mileage=' + miles + '&desired_coverage_level=' + cover + '&vehicle_ownership=' + own + '&has_insurance=' + has + '&current_insurance_provider=' + current + '&gender=' + gender + '&married=' + married + '&education_level=' + education + '&credit_score=' + credit + '&tickets_or_claims_in_last_three_years=' + tc + '&ever_filed_sr22=' + sr);
...
export default withRouter(SR22)