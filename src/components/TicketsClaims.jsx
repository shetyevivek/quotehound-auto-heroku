...
class TicketsClaims extends Component {

    nextStep = (values) => {

        values.preventDefault();
        
        let tc = values.currentTarget.dataset.value;
       ...
       this.props.setTicketsClaims(tc)
        
        this.props.history.push('/sr-22' + '?zip_code=' + zipCode + '&car_year=' + carYear + '&car_model=' + carModel + '&car_make=' + carMake + '&primary_usage=' + use + '&annual_mileage=' + miles + '&desired_coverage_level=' + cover + '&vehicle_ownership=' + own + '&has_insurance=' + has + '&current_insurance_provider=' + current + '&gender=' + gender + '&married=' + married + '&education_level=' + education + '&credit_score=' + credit + '&tickets_or_claims_in_last_three_years=' + tc);
                                ...
                                <div>
                                    <div className="relative flex justify-center text-sm leading-5 con">
                                        <span className="px-2 text-black-500 text-3xl bold header">
                                            Have you had tickets or claims in the last 3 years?
                                         </span>
                                    </div>
                                </div>
                                <form>
...
export default withRouter(TicketsClaims)