...
class HasInsurance extends Component {

    nextStep = (values) => {

        values.preventDefault();
        
        let has = values.currentTarget.dataset.value;
       ...
       this.props.setInsuranceStatus(has)
        
        this.props.history.push('/current-insurance' + '?zip_code=' + zipCode +  '&car_year=' + carYear + '&car_model=' + carModel + '&car_make=' + carMake + '&primary_usage=' + use + '&annual_mileage=' + miles + '&desired_coverage_level=' + cover + '&vehicle_ownership=' + own + '&has_insurance=' + has);
                                ...
                                <div>
                                    <div className="relative flex justify-center text-sm leading-5 con">
                                        <span className="px-2 text-black-500 text-3xl bold header">
                                            Have you had <b>Auto</b> insurance in the past 30 days?
                                         </span>
                                    </div>
                                </div>
                                <form>
...
export default withRouter(HasInsurance)